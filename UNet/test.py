...
if __name__ == "__main__":
    ...
    test_data = Test(img_pth = '/content/drive/MyDrive/TC_2021/segmentation_default_result/white_line_real/opening_1.jpg', \
    mask_pth = '/content/drive/MyDrive/TC_2021/segmentation_default_result/white_line_real_L/opening_1_L.jpg', transform=test_transform)
    #data loaders
    ...
    Visualize(imgs, 'Original Image', 1, 1, change_dim=True)
    Visualize(masks, 'Original Mask', 1, 1, change_dim=True)
    Visualize(pred, 'Predicted mask', 1, 1, change_dim=False)